  ...
  return <main className="coverage-shell">
    ...
    <div className="coverage-page">
      ...
      {loading ? <div className="coverage-empty">Reading class evidence…</div> : <>
        {priority && activeClass && <section className="coverage-priority-banner"><div><small>CAPTURE NEXT</small><strong>{priority.name}</strong><p>{priorityReason(priority)}</p></div><a href={captureHref(activeClass.id, priority.id)}>Open focused capture →</a></section>}
